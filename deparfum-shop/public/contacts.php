...
<div class="wrapper1">
    ...
    <div class="grid-container">
      <div class="grid-item-left">
        <img src="/IMAGES/photo_5226917969249034793_y.jpg">
      </div>
      <div class="grid-item-right">
        <div class="contacts-info">
          ...
          <span>
          <h2>+375 (29) 888-87-19 </h2>
          <p>для заказов с доставкой по территории Республики Беларусь</p> 
          </span>
  
          <span>
          <h2>Коммерческий отдел</h2>
          <p>пишите по предложениям заведения новых брендов и вопросам ассортимента</p>
          <p>email: commerce@deparfum.by</p>
          </span>
  
          <span>
          <h2>Маркетинговый отдел</h2>
          <p>пишите по вопросам маркетинговой активности и рекламе</p>
          <p>email: marketing@deparfum.by</p> 
          </span>
